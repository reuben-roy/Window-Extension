...
export default function AccountStatusControl({
    ...
    return (
      <div ref={rootRef} className="relative flex flex-col items-end gap-1.5">
        <button
          ...
          className="fg-button-primary whitespace-nowrap"
        >
          {busyAction === 'google' ? 'Opening…' : 'Sign in with Google'}
        </button>

        <div className="rounded-md border border-[var(--fg-border)] bg-white/90 px-2.5 py-1.5 shadow-sm">
  ...
  return (
    <div ref={rootRef} className="relative">
      ...
      {menuOpen && (
        <div className="absolute right-0 z-30 mt-2 w-[min(320px,calc(100vw-1rem))] rounded-lg border border-[var(--fg-border)] bg-white p-3 shadow-xl">
          ...
          <div className="mt-3 rounded-lg border border-[var(--fg-border)] bg-[var(--fg-panel-soft)] p-2.5">
